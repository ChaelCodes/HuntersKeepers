...
import HunterUseMove from '../components/hunter_use_move.vue'
...
document.addEventListener('turbolinks:load', () => {
  const app = new Vue({
    el: '#vue-app',
    components: { HunterGear, HunterMoves, HunterRatings, HunterRollMove, HunterUseMove, HuntersImprovementForm },
  }).default
})
