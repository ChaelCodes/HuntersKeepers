...
RSpec.describe Improves::AnotherMove do
  ...
  let(:improvement) { create :another_move }
  ...
  describe '#improve' do
    ...
    context 'when move is from the same playbook' do
      ...
      it 'adds error to hunters improvement' do
        ...
        expect(hunters_improvement.errors.full_messages)
          .to include match(/Move matches improvement playbook/)
      end
    end
  end
end
