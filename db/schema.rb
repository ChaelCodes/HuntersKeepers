...
ActiveRecord::Schema.define(version: 20_191_027_135_117) do
  ...
  create_table 'hunters_improvements', force: :cascade do |t|
    ...
    t.index %w[improvable_type improvable_id], name: 'index_hunters_improvements_on_improvable_type_and_improvable_id'
  end
